...
export default function SkillComp({skill, position, openUpdateEditor, removeSkill, updateSkill, isEditorOpen} : SkillProps) {
  ...
  return (
    <Draggable draggableId={`${skill.id}`} index={position} >
      {(provided) => (
        <div 
